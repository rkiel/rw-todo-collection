...
/***/ function(module, exports, __webpack_require__) {
	...
	function render() {
	  var listItems = this.state.list.map(function(item){
	    return (
	      React.createElement(ListContainer, {title: item.newTitle, key: item.index, remove: this.removeFromList.bind(null,item.index), index: item.index})
	    );
	  }.bind(this));
	    return (
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(3);
	var AddItem = __webpack_require__(4);
	  ...
	  return (
	    React.createElement("div", {className: "col-sm-6"}, 
	      React.createElement("div", {className: "col-sm-12", style: styles.container}, 
	        React.createElement("span", {className: "glyphicon glyphicon-remove", style: styles.remove, onClick: this.props.remove.bind(null,this.props.index)}), 
	...
	function render() {
	  return (
	      React.createElement("div", {className: "col-sm-6"}, 
	        ...
	        React.createElement("input", {type: "text", className: "form-control", value: this.state.listName, onChange: this.handleChange, placeholder: "List Name"}), 
	        React.createElement("button", {onClick: this.handleSubmit, className: "btn btn-primary"}, "Submit")
	      )
	  );
	}
